...
import { Mail, Phone, MapPin } from "lucide-react"; // Icone da lucide-react
...
export default function Contatti() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Qui potresti inviare i dati a un backend (es. FastAPI)
    ...
    <main className="min-h-screen bg-gray-100 text-gray-900">
      ...
      <section className="py-16 px-6 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="mt-2 text-gray-600">info@cyberlab.com</p>
          </motion.div>
          <motion.div
            className="flex flex-col items-center text-center"
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <p className="mt-2 text-gray-600">+39 123 456 7890</p>
          </motion.div>
          <motion.div
            className="flex flex-col items-center text-center"
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <h3 className="text-xl font-semibold">Sede</h3>
            <p className="mt-2 text-gray-600">Via Pietro Bucci, 87036 Arcavacata, Cosenza</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-8">Invia un messaggio</h2>
          {submitted ? (
            <motion.p
      ...
      <section className="py-16 px-6 bg-gray-100">
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3084.7543634149965!2d16.223554775772747!3d39.36179887162865!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x133f999aaa86af19%3A0xe6050cd7c28559ba!2sUniversit%C3%A0%20della%20Calabria!5e0!3m2!1sit!2sit!4v1743667999410!5m2!1sit!2sit" 
          width="100%" 
          height="450" 
          style={{ border: 0 }}
          allowFullScreen
